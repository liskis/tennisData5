...
struct DblsPositionBtnArea: View {
    ...
    var body: some View {
        VStack(spacing: 1){
            if positionVM.servOrRet == .serviceGame {
                serviceGameVolleyerBtn
                serviceGameServerBtn
            } else if positionVM.servOrRet == .returnGame {
                returnGameVolleyerBtn
                returnGameReturnerBtn
    ...
    private var serviceGameVolleyerBtn: some View {
        HStack(spacing:1){
    ...
    private var serviceGameServerBtn: some View {
        HStack(spacing:1){
    ...
    private var returnGameVolleyerBtn: some View {
        HStack(spacing:1){
            if positionVM.myPosition == .volleyer && positionVM.side == .duceSide {
    ...
    private var returnGameReturnerBtn: some View {
        HStack(spacing:1){
